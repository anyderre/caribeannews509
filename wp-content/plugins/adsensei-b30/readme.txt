=== AdSensei B30===
Contributors: blogger30, mejorhombre.com
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=S5FAA3U89ZPEN
...
¡AHORA CON TEXTO EN CATEGORÍAS Y TEXTO EN LA HOME!
...
* Shortcodes configurables(ver <a href="https://wordpress.org/plugins/adsensei-b30/faq/">FAQ</a>)
...
* Puedes ver todos los detalles del plugin y un vídeo explicativo en <a href="http://blogger3cero.com/adsensei-b30/" target="_blank">blogger3cero AdSensei</a>
...
== Screenshots ==
1. Panel de Control: hasta 10 anuncios altamente configurables
2. Comparación de alineación 'Izquierda Envuelto' vs 'Izquierda' (también disponible derecha y derecha envuelto)

== Frequently asked questions ==
= ¿Cómo puedo 'desactivar' el plugin en una página o post concreto? =
   Puedes usar el shortcode <b>[sin_anuncios_b30]</b> en cualquier post o página para que el plugin no inserte ningún anuncio.
= ¿Cómo puedo insertar 'manualmente' anuncioes en una página o post concreto? =
   Puedes anular la funcionalidad por defecto del plugin e insertar tus anuncios en sitios concretos usando shortcodes del tipo <b>[anuncio_b30 id=x]</b> siendo X el número de anuncio que quieras insertar. Por ejemplo para insertar el anuncio 1: [anuncio_b30 id=1]
= ¿Qué diferencia hay entre las alineaciones 'Izquierda Envuelto' o 'Derecha Envuelto' y simplemente 'Izquierda' o Derecha'? =
  ...
  Te aconsejamos echar un vistazo a las capturas de pantalla para visualizarlo mejor: <a href="https://wordpress.org/plugins/adsensei-b30/screenshots/">Capturas de pantalla</a>
...
= 1.9.3 =
* Solucionada incidencia con la etiqueta <more> cuando estaba pegada a un párrafo
= 1.9.2 =
